...
const dialogues = {
    ...
    10: {
        ...
        image: "../Assets/perso 3.png"
    }
};

// NOTE assets : les visuels dedies aux dialogues de cle (key_1/key_2) n'ont
// jamais existe (l'ancien chemin ../Assets/characters/*.png pointait vers un
// dossier absent -> image cassee). On reutilise perso 4.png (avatar deja
// detoure/transparent) en placeholder. A remplacer par des visuels dedies
// si besoin (meme convention : PNG transparent dans Assets/).
const keyDialogues = {
    1: {
